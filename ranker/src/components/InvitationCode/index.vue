  ...
  <transition appear name="slide-fade">
    <div class="code-container" @click.self="goHome">
      <div class="modal">
        ...
        <h1>请输入邀请码</h1>
        <div class="input">
          <input v-model="filledCode" type="number" pattern="[0-9]" maxlength="6" min="0" max="999999"
            placeholder="6位邀请码" autofocus>
          <button :class="{ active: filledCode.length === 6 }" @click="submitCode">
            确定
          </button>
        </div>
        <h2>我的邀请码</h2>
